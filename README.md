...
graph TD
    ...
    Engine["🧠 2. ДВИГАТЕЛЬ & КОМПЬЮТЕР (Ядро Captain OS, Блокировки)"]
    Gearbox["⚙️ 3. КОРОБКА ПЕРЕДАЧ (Стейт-машина задач)"]
    Tank["⛽ 4. БЕНЗОБАК (Контекст, RAG-база, Реестр качества)"]
    Wheels["🏎️ 5. ПОДВЕСКА & КОЛЕСА (Исполнительный LLM: Gemini / Claude / Codex)"]
...
Двигатель — это центральный управляющий блок:
...
Колеса и подвеска — это сама большая языковая модель (Gemini, Claude, Codex), которая непосредственно взаимодействует с кодом:

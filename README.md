...
graph TD
    ...
    Gate9 -->|"Ledger валиден"| Gate10{"🚨 10. StarPom CSS / Design System Audit"}:::gate
    
    Gate10 -->|"Нарушены CSS-токены"| Block9["🚫 БЛОК: Исправьте ad-hoc стили"]:::block
    ...
    Gate11 -->|"Размер PR в норме"| Gate12{"🚨 12. Studio/Public Boundary Gate"}:::gate
    
    Gate12 -->|"CMS в публичном контуре"| Block11["🚫 БЛОК: Утечка защищенных роутов"]:::block
...
| | **10. StarPom CSS / Design System Audit** | Авто | Утилита `content-css-audit` сканирует новые стили на соответствие дизайн-токенам. Блокирует ad-hoc стили и дублирование UI-элементов. |
...
| | **12. Studio/Public Boundary Gate** | Авто | **Безопасность контуров**. Жестко контролирует, чтобы CMS/Admin роуты были отрезаны от публичного домена `plexo.institute` и жили исключительно на `studio.plexo.institute`. |

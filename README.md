...
graph TD
    ...
    Wheels["🏎️ 5. ПОДВЕСКА & КОЛЕСА (Исполнение изменений на хосте)"]
    ...
    Gearbox -->|Переключает состояния| Wheels
...
Колеса и подвеска — это то, как система физически переносит изменения на ваш локальный рабочий хост:

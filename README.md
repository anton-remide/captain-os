...
graph TD
    ...
    subgraph EngineBlock["🧠 2. ДВИГАТЕЛЬ & КОМПЬЮТЕР (Ядро Captain OS)"]
        ...
        Pistons["🔥 Поршни (6 поршней: 4 основных + 2 буст-ЛЛМ)"]
...
* **🔥 Поршни двигателя (ЛЛМ-рантаймы)**: Внутри двигателя работают поршни. Представьте себе 6-поршневой двигатель:
  * **4 основных поршня** работают на базе основной модели рантайма (активного Капитана, например Gemini), которая берет на себя базовую нагрузку.
  * **2 дополнительных поршня** (другие ЛЛМки, например Claude-Code или Codex в качестве ревьюеров) автоматически поднимаются для ускорения сложных вычислений, глубокого анализа кода и повышения общего качества работы двигателя.
